function [x,resnorm,residual] = fittingSQRD_onNetwork(Q,R,D,Npop,S0,L,time,x0,flag,varargin)
...
ydata = [Q;R;D];
if flag==1
    ub = ones(1,19); % upper bound of the parameters
    lb = zeros(1,19); % lower bound of the parameters
else
    ub = ones(1,18); % upper bound of the parameters
