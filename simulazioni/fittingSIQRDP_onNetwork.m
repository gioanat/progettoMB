function [x,resnorm,residual] = fittingSIQRDP_onNetwork(Q,R,D,Npop,S0,P0,I0,Q0,R0,D0,L,time,x0,flag,varargin)
...
ydata = [Q;R;D];
if flag==1
    ub = [5*ones(1,6) ones(1,32)]; % upper bound of the parameters
    lb = zeros(1,38); % lower bound of the parameters
else
    ub = [5*ones(1,6) ones(1,30)]; % upper bound of the parameters
