function [x,resnorm,residual] = fittingSEIQRDP_onNetwork(Q,R,D,Npop,S0,P0,E0,I0,Q0,R0,D0,L,time,x0,flag,varargin)
...
ydata = [Q;R;D];
if flag==1
    ub = [1*ones(1,6) ones(1,38)]; % upper bound of the parameters
    lb = zeros(1,44); % lower bound of the parameters
else
    ub = [1*ones(1,6) ones(1,36)]; % upper bound of the parameters
